...
namespace BusinessHelpers;

public class JWTTokenFailHelper
{
    public static APIResult<T> GetFailResult<T>(Exception exception)
    {
        ...
        if (exception is ArgumentException)
        {
            ...
            {
                apiResult = APIResultFactory.Build<T>(false, StatusCodes.Status401Unauthorized,
